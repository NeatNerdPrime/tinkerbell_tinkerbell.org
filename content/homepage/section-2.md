...
There are also a few optional components: 2 Power and Boot services ([PBnJ](/docs/services/pbnj/) and [Rufio](/docs/services/rufio/)) that communicate with BMCs. And a Cluster API provider ([CAPT](/docs/services/cluster-api-provider-tinkerbell/)) for provisioning and managing Kubernetes clusters.
